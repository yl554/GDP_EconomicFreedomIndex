...
There are 8 points with high leverage, but among all those points, none of them has cook distance larger than 1. So, they don’t have significant influence on model coefficients.
...
There are 8 observations that are considered to have large standardized residues with large magnitudes. If ploted the distribution of standardized residuals using a N(0,1) distribution, we can expect 8/173 = 4.62% of the observations have standardized residues with magnitude > 2.
