...
d <- ggplot(data = economic_data_temp, mapping = aes(x = Population)) +
  ...
  labs(x = "Population (Million)",
       y = "Frequency",
       title = "Distribution of Population (No Outliers)") + theme_classic() + 
  theme(plot.title = element_text(size = 12))
...
```{r EDA2}
a <- ggplot(data = economic_data, aes(x = Inflation)) +
  geom_histogram(fill = "forestgreen") + 
  labs(x = "Inflation (%)",
       y = "Frequency",
...
b <- ggplot(data = economic_data_temp, mapping = aes(x = Inflation)) +
  ...
  labs(x = "Inflation (%)",
       y = "Frequency",
       title = "Distribution of Inflation w/o Outlier") + 
...
g <- ggplot(mapping = aes(x = GovInterference), data = economic_data) +
  geom_bar(fill = "forestgreen") +
  labs(title = "Bar Graph of GovInterference", x  = "Levels of Government Interference", y = "Frequency") + 
  theme(plot.title = element_text(size = 12))+  theme_classic()
...
`Inflation` represents the change in prices of goods and services in a year in the country. The distribution of inflation rate is generally unimodal and right skewed. The median inflation rate is 2.7% and the IQR is 4%. These summary statistics are printed below.
...
Inflation > 6% = "Dangerously High" </br>
Inflation 3-4% = "High" </br>
Inflation 1-3% = "Healthy" </br>
Inflation <1% = "Low"

This categorization is informed by extant economic literature (Refer to Citations)
```{r inflation-eda}
economic_data <- economic_data %>%
...
ggplot(mapping = aes(x = GovInterference, y = logGDP))+
  theme_classic() +
  geom_boxplot(position="dodge") +
  labs(title = "Boxplots of log GDP versus\n Government Interference")+
  theme_classic() +
  theme(plot.title = element_text(size = 8))+  theme_classic()
...
Our approach is: running model selection using all three selection criteria - AIC, BIC, and adjusted R^2 - and comparing all three models to decide on the final model.

Model selected using AIC:
logGDP ~ TariffRate + logpop + GDPGrowth + TaxBurdenCent + GovSpendingCent + cat_inflationDangerouslyHigh + cat_inflationHigh + cat_inflationLow + RegionAsia-Pacific + RegionEurope + RegionMiddleEastandNorthAfrica + RegionSub-SaharanAfrica (plus) GovInterferenceExtensive + GovInterferenceRepressive + GovInterferenceLimited 
...
a <- ggplot(data=economic_data,aes(x=predicted, y=residuals)) + 
  ...
  labs(title="Scatterplot of Resid. vs. Predicted Values")+
  theme_classic() + 
...
b <- ggplot(data=economic_data,aes(x=TariffRate, y=residuals)) + 
  ...
  labs(x = "TariffRate", 
       y = "Residuals",
       title = "Scatterplot of Resid. vs. TariffRate")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
c <- ggplot(data=economic_data,aes(x=logpop, y=residuals)) + 
  ...
  labs(x = "log of Population", 
       y = "Residuals",
       title = "Scatterplot of Resid. vs. log of Population")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
d <- ggplot(data=economic_data,aes(x=TaxBurdenCent, y=residuals)) + 
  ...
  labs(x = "CorporateTaxRate", 
       y = "Residuals",
       title = "Scatterplot of Resid. vs. CorporateTaxRate")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
e <- ggplot(data=economic_data,aes(x=GovInterference, y=residuals)) + 
  ...
  labs(x = "GDPGrowth", 
       y = "Residuals",
       title = "Boxplot of Residuals vs. GDPGrowth")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
f <- ggplot(data=economic_data,aes(x=cat_inflation,y=residuals)) + 
  ...
  labs(x = "Inflation", 
       y="Residuals",
       title="Boxplot of Residues vs. Inflation")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
g <- ggplot(data=economic_data,aes(x=Region, y=residuals)) + 
  ...
  labs(x = "Region", 
       y = "Residuals",
       title = "Boxplot of Residuals vs. Region")+
  theme_classic() + 
  theme(plot.title = element_text(size = 11))
...
d <- ggplot(data = economic_data_temp, mapping = aes(x = Population)) +
  ...
  labs(x = "Population (Million)",
       y = "Frequency",
       title = "Dist. of Population (No Outliers)") +  theme_classic()+ 
  theme(plot.title = element_text(size = 12))
...
b <- ggplot(data = economic_data_temp, mapping = aes(x = Inflation)) +
  ...
  labs(x = "Inflation (%)",
       y = "Frequency",
       title = "Distribution of Inflation without Outlier")+  theme_classic()+ 
  theme(plot.title = element_text(size = 12)) 
...
f <- ggplot(mapping = aes(x = GovInterference), data = economic_data) +
  geom_bar(fill = "forestgreen") +
  labs(title = "Bar Graph of Government\n Inteference", x  = "Levels of Government Interference", y = "Frequency") + 
  theme(plot.title = element_text(size = 12))+  theme_classic()
